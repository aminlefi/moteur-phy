...
public static class Math3D
{
    ...
    public static Matrix4x4 ViewMatrix(Vector3 position, Vector3 target, Vector3 up)
    {
        ...
        view[0, 0] = xAxis.x; view[0, 1] = xAxis.y; view[0, 2] = xAxis.z; view[0, 3] = -Vector3.Dot(xAxis, position);
        view[1, 0] = yAxis.x; view[1, 1] = yAxis.y; view[1, 2] = yAxis.z; view[1, 3] = -Vector3.Dot(yAxis, position);
        view[2, 0] = zAxis.x; view[2, 1] = zAxis.y; view[2, 2] = zAxis.z; view[2, 3] = -Vector3.Dot(zAxis, position);
        return view;
    }
}
