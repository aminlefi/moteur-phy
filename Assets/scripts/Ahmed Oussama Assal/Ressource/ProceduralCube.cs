...
public class ProceduralCube : MonoBehaviour
{
    ...
    void Build()
    {
        ...
        // Ensure material exists to avoid NRE if not assigned in inspector
        ...
        if (mr.sharedMaterial == null) mr.sharedMaterial = material; else mr.sharedMaterial.color = color;
    }
