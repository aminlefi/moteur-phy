...
public class RigidBody3DState : MonoBehaviour
{
    ...
    void Start()
    {
        cube = new RigidCubeObject(a, b, c, Color.green);
    ...
    public void ApplyImpulse(Vector3 impulse, Vector3 point)
    {
        ...
        Vector3 r = point - position; // Vector from center of mass to application point
        L += Vector3.Cross(r, impulse);
    }

    public void ApplyForce(Vector3 force)
    {
        P += force * dt; // Update linear momentum
    }
    ...
    public void HandleCollision(Vector3 normal)
    {
        // Reflect velocity based on collision normal
        Vector3 velocity = P / mass;
        Vector3 reflectedVelocity = Vector3.Reflect(velocity, normal);
        P = reflectedVelocity * mass;
    }
